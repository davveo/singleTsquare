...
type AccountUser struct {
	gorm.Model
	UserName    string         `json:"userName" gorm:"not null;unique;comment:'用户登录名'"`
	PassWord    sql.NullString `json:"-"  gorm:"not null;comment:'用户登录密码'"`
...
type Member struct {
	...
	NickName string `json:"nickname" gorm:"default:'';comment:'昵称'"`
